...
var user_bod = document.getElementById("user_bod");
var user_followers = document.getElementById("user_followers");
var user_plan = document.getElementById("user_plan");
// access info
var access_token = document.getElementById("access_token");
var access_type = document.getElementById("access_type");
var access_expiry = document.getElementById("access_expiry");
var refresh_token = document.getElementById("refresh_token");
var access_scope = document.getElementById("access_scope")
// links
var playlists_link = document.getElementById("playlists_link")
...
function apply_user_data(data){
  ...
  user_bod.innerHTML = date.toLocaleDateString(date, {year: "numeric", month: "short", day: "numeric"})

  var country = getCountryName(data['country'])
  user_country.innerHTML = country

  user_email.innerHTML = data['email']
  user_followers.innerHTML = data['followers']['total']

  var plan = data['product']
  plan = plan.charAt(0).toUpperCase() + plan.slice(1);
  user_plan.innerHTML = plan
}

// Applies access data to the HTML document
function apply_access_data(data){
  access_token.innerHTML =  data['access_token'];
  access_type.innerHTML =  data['token_type'];
  access_expiry.innerHTML =  data['expires_in'];
  refresh_token.innerHTML =  data['refresh_token'];
  access_scope.innerHTML =  data['scope'];
}
